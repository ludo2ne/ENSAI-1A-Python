...
Si des valeurs sont utilisées plusieurs fois dans tes tests, les fixtures permettent de les définir une seule fois et de les réutiliser facilement.
...
L'exemple ci-dessus était principalement à vertu pédagogique.
...
- Avant ou après chaque test

À ajouter si besoin dans le module de test :
