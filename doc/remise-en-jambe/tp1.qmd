...
- [ ] Dans le dossier *src*, créez un fichier *boucles.py*
- [ ] Créez une liste *l10* contenant tous les entiers de 0 à 10
- [ ] Créez une liste *l10desc* contenant tous les entiers de 10 à 10
...
- [ ] Créer une liste *l20rand* contenant 20 entiers dont les valeurs sont comprises entre 1 et 9
...
Que se passe-t-il si `nombre=0` ? Il faut gérer ce cas, par exemple :
...
Quand une fonction devient plus complexe, il est important de documenter et d'indiquer les types attendus pour les paramètres et pour le retour.
...
Cependant, l'ajout des types de paramètres est purement indicatif. Si l'on veut intégrer des restrictions, il faut vérifier les types dans le code:
